...
if __name__ == '__main__':
    print('Here are the rules of the game: scissor cuts paper,paper covers rock,'
          ' and rock crushes scissors.\nPlay either "rock", "paper", or'
    ...
    while game_type not in ["random", "reflect", "repeat", "cycle"]:
        ...
        game_type = input('Who would you like to play with? Please enter "random",'
